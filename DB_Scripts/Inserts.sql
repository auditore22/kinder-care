...
-- Insert into Relación Tarea-Nino
EXEC GestionarTareas @id_nino = 1, @id_profesor = 1, @nombre = 'Matemáticas - Examen 1',
     @descripcion = 'Examen de álgebra básica', @fecha_entrega = '2024-12-01', @accion = 'AGREGAR';

EXEC GestionarTareas @id_nino = 1, @id_profesor = 2, @nombre = 'Lenguaje - Ensayo',
     @descripcion = 'Escribir un ensayo sobre literatura moderna', @fecha_entrega = '2024-12-10', @accion = 'AGREGAR';

EXEC GestionarTareas @id_nino = 1, @id_profesor = 4, @nombre = 'Historia - Proyecto de investigación',
     @descripcion = 'Realizar un proyecto de investigación sobre la Revolución Industrial',
     @fecha_entrega = '2024-12-20', @accion = 'AGREGAR';
