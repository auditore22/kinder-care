...
public class UserProfile : Controller
{
        ...
        string RoleName)
    {
        ...
        if (Nombre != usuario.Nombre || Direccion != usuario.Direccion ||
            CorreoElectronico != usuario.CorreoElectronico)
        {
            var result = await _context.Database.ExecuteSqlRawAsync(
                "EXEC GestionarUsuario @IdUsuario = {0}, @Cedula = {1}, @Nombre = {2}, @Num_Telefono = {3}, @Direccion = {4}, @CorreoElectronico = {5}, @IdRol = {6}, @Activo = {7}, @Accion = {8}",
